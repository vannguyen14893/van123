...
public class PostCommentController {
	...
	@PostMapping(value = "/postComment/user/{userId}/post/{postId}")
	public void deletePostComment(@PathVariable("userId") Integer userId, @PathVariable("postId") Integer postId,
			@RequestBody PostComment postComment) {
		postCommentServiceImpl.deletePostComment(userId, postId, postComment.getCommentId());
	}
}
